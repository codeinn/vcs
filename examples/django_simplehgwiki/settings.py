...
# Django settings for django_repos project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'repos.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'llg%xug$ugtw_wut8kv9%+wt-(y174!!k1l@=_ak4#xyi@il*i'
